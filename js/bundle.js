...
function calc() {
  ...
  function setDefaultInfo(parentSelector, activeClass) {
    if (localStorage.getItem('sex') != null) {
      ...
      document.querySelectorAll("".concat(parentSelector, " div")).forEach(function (item) {
    ...
    if (localStorage.getItem('ratio') != null) {
      ...
      document.querySelector("[data-ratio=\"".concat(ratio, "\"]")).classList.add('calculating__choose-item_active');
    } else {
      ratio = '1.375';
    ...
    elements.forEach(function (elem) {
      elem.addEventListener('click', function (e) {
        if (e.target.getAttribute('data-ratio')) {
          ...
          localStorage.setItem('sex', "".concat(sex));
        }
...
function cards() {
  var Card = /*#__PURE__*/function () {
    function Card(src, alt, title, descr, price, parent) {
...
function forms(formSelector, timerId) {
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["showModal"])('.modal', timerId);
...
function slider(_ref) {
  ...
  next.addEventListener('click', function () {
    if (offset == deletePxStr(width) * (slides.length - 1)) {
      //'500px'
      offset = 0;
    } else {
...
window.addEventListener('DOMContentLoaded', function () {
  var timerId = setTimeout(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["showModal"], 100000, '.modal');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', timerId);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2021-03-10');
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])('form', timerId);
